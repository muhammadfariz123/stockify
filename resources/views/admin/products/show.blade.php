...
@section('content')
    <div class="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 p-4 lg:p-6">
        <div class="max-w-4xl mx-auto">
            ...
            <div class="mb-8">
                <h1
                    class="text-3xl lg:text-4xl font-bold bg-gradient-to-r from-slate-900 to-slate-600 bg-clip-text text-transparent mb-2">
                    Detail Produk
                </h1>
            ...
            <div class="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-white/20 overflow-hidden mb-6">
                ...
                <div class="bg-gradient-to-r from-slate-50 to-slate-100 px-6 py-5 border-b border-slate-200/50">
                    <div class="flex items-center space-x-4">
                        <div
                            class="w-16 h-16 bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl flex items-center justify-center shadow-md">
                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="bg-slate-50 rounded-xl p-4">
                                <span
                                    class="inline-flex items-center px-3 py-1.5 rounded-full text-sm font-semibold bg-gradient-to-r from-blue-100 to-blue-200 text-blue-800 shadow-sm">
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="bg-emerald-50 rounded-xl p-4">
                                <div class="flex items-center space-x-2">
                                    <span
                                        class="inline-flex items-center px-4 py-2 rounded-full text-lg font-bold bg-gradient-to-r from-emerald-500 to-emerald-600 text-white shadow-md">
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="bg-amber-50 rounded-xl p-4">
                                <div class="flex items-center space-x-2">
                                    <span
                                        class="inline-flex items-center px-4 py-2 rounded-full text-lg font-bold bg-gradient-to-r from-amber-500 to-amber-600 text-white shadow-md">
                        ...
                        <div class="space-y-3 md:col-span-2">
                            ...
                            <div class="bg-slate-50 rounded-xl p-4">
                                <span
                                    class="inline-flex items-center px-3 py-1.5 rounded-full text-sm font-semibold bg-gradient-to-r from-purple-100 to-purple-200 text-purple-800 shadow-sm">
                        ...
                        <div class="space-y-3 md:col-span-2">
                            <div class="flex items-center space-x-2">
                                ...
                                <strong class="text-slate-700 font-semibold">Stok Produk:</strong>
                            </div>
                            <div class="bg-slate-50 rounded-xl p-4">
                        ...
                        <div class="space-y-3 md:col-span-2">
                            <div class="flex items-center space-x-2">
                                ...
                                <strong class="text-slate-700 font-semibold">Deskripsi Produk:</strong>
                            </div>
                            <div class="bg-slate-50 rounded-xl p-4">

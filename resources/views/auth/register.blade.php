...
<body class="min-h-screen flex items-center justify-center p-4 relative">
    ...
    <div class="w-full max-w-md relative z-10">
        <form method="POST" action="{{ route('register') }}" class="glass-effect p-8 rounded-2xl shadow-2xl">
            <!-- CSRF Token (Laravel) -->
            ...
            <div class="mb-6">
                ...
                <div class="mt-2 text-red-600 text-sm" id="name-error">
                    <!-- Name validation errors would appear here -->
                </div>
            </div>
            ...
            <div class="mb-6">
                ...
                <div class="input-group relative">
                    <input id="password"
                        ...
                        placeholder="Enter your password" oninput="checkPasswordStrength(this.value)">
                ...
                <div class="mt-2 text-xs text-gray-500" id="password-strength-text">
                    Password strength: <span id="strength-level">None</span>
                </div>
                <!-- Error messages placeholder -->
            ...
            <div class="mb-6">
                ...
                <div class="input-group relative">
                    ...
                    <button type="button" class="absolute right-3 top-3 text-gray-400 hover:text-gray-600"
                        ...
                        <i class="fas fa-eye" id="password-confirmation-toggle"></i>
                    </button>
                </div>
                <div class="mt-2 text-xs" id="password-match-indicator">
                    <!-- Password match indicator -->
                </div>
                <!-- Error messages placeholder -->
                <div class="mt-2 text-red-600 text-sm" id="password-confirmation-error">
                    <!-- Password confirmation validation errors would appear here -->
                </div>
            </div>
            ...
            <div class="mb-6">
                ...
                <div class="input-group">
                    <select id="role" name="role"
                        class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent outline-none transition-all duration-300 bg-white/50 appearance-none cursor-pointer">
                        <option value="Staff Gudang" {{ old('role') == 'Staff Gudang' ? 'selected' : '' }}>Staff Gudang
                        </option>
                ...
                <!-- Error messages placeholder -->
                <div class="mt-2 text-red-600 text-sm" id="role-error">
                    <!-- Role validation errors would appear here -->
                </div>
            </div>
    ...
    <script>
        ...
        function checkPasswordStrength(password) {
            ...
            strengthText.className = strength <= 2 ? 'text-red-500' : strength === 3 ? 'text-yellow-500' : 'text-green-500';
        }
        ...
        function checkPasswordMatch() {
            ...
            if (password === confirmPassword) {
                ...
                indicator.className = 'mt-2 text-xs text-red-600';
            }
        }

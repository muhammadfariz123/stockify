...
@section('content')
    <div class="max-w-4xl mx-auto p-8 bg-white rounded-lg shadow-xl mt-8">
        ...
        <form action="{{ route('admin.products.store') }}" method="POST" class="space-y-6">
            ...
            <!-- Harga Jual -->
            <div class="mb-6">
                <label for="sale_price" class="block text-gray-700 font-medium mb-2">Harga Jual</label>
            ...
            <button type="submit"
                class="w-full py-3 bg-gradient-to-r from-green-500 to-green-600 text-white rounded-lg shadow-md hover:from-green-600 hover:to-green-700 focus:outline-none transition-all duration-300 transform hover:scale-105">Simpan
                Produk</button>
        </form>
